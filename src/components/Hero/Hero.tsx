  ...
  return (
    <article className="bg-lightBlueBase relative mb-16 h-56 pt-8 sm:h-64 md:h-60 lg:h-80 xl:h-96 2xl:h-[30rem]" >
      <section className="ml-8 w-3/5 md:ml-20 md:w-3/6 lg:ml-32 lg:w-3/6 xl:mt-10 xl:w-3/6 2xl:ml-[15%] 2xl:mt-16">
        ...
        <h2 className='text-base sm:text-base lg:text-2xl xl:text-3xl 2xl:text-4xl' >A motivated and enthusiastic frontend/ webdeveloper and UX designer</h2>
      </section>
      <Image className='absolute bottom-8 right-4 md:left-2/3 lg:left-auto lg:right-16 xl:right-32 2xl:right-[10%] 2xl:mt-16' src="/heroImg.webp" alt="Hero image" width={imageSize} height={imageSize} />
