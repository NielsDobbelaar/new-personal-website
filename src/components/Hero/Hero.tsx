...
export default function Hero() {
  ...
  return (
    <article className="bg-lightBlueBase relative mb-16 h-56 pt-8 sm:h-64 md:h-60 lg:h-80 xl:h-96 2xl:h-[30rem]" >
      ...
      <Image className='absolute left-2/3 top-8 lg:left-auto lg:right-16 xl:right-32 2xl:right-[10%] 2xl:mt-16' src="/heroImg.webp" alt="Hero image" width={imageSize} height={imageSize} />
